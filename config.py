...
from bher.common import logger
from bher.algo.ddpg import DDPG
from bher.algo.samplers import make_sample_her_transitions, make_random_sample, make_default_sample
...
DEFAULT_PARAMS = {  
    ...
    'network_class': 'bher.algo.actor_critic:ActorCritic',
...
def prepare_params(kwargs):
    ...
    if kwargs['use_bootstrap_her'] and kwargs['use_her_buffer'] and not kwargs['only_her_data']:
    ...
    for name in ['buffer_size', 'hidden', 'layers','network_class','polyak','batch_size', 
                 ...
                 'scope', 'relative_goals', 'k_heads', 'share_network', 'k_goals', 'greedy_sample',
                 'reverse_priority', 'prioritized_replay', 'priority_temperature',
                 'use_bootstrap_her', 'use_her_buffer', 'her_buffer_size', 'sample_from_buffer',
